...
public class MainOTM {
    public static void main(String[] args) {
        ...
        Client c = entityManager
                .createQuery("FROM OTM.Client p WHERE name=:clientName", Client.class)
        ...
        Address a = entityManager
                .createQuery("FROM OTM.Address p WHERE clientAddress=:addressName", Address.class)
        ...
        Manager m = entityManager
                .createQuery("FROM OTM.Manager m WHERE name=:managerName", Manager.class)
